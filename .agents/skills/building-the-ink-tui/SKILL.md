...
metadata:
  type: task
  verification_signal: npm test (ink-testing-library renders the menu PT/EN) + node -e import of src/ui/App.js loads the graph + `echo "" | node src/index.js` falls back to help (non-TTY)
---
